    ...
    nodeStoryFragment(id: { eq: $id }) {
      ...
      relationships {
        ...
        field_panes {
          ...
          field_slug
          field_options
          field_height_ratio: field_height_ratio_tablet
          field_height_offset: field_height_offset_tablet
          relationships {
            field_pane_fragments {
              ...
              ... on paragraph__background_pane {
                id
                field_zindex
                field_shape: field_shape_tablet
                field_hidden_viewports
                field_options
                internal {
                  type
              ...
              ... on paragraph__background_video {
                ...
                field_zindex
                field_alt_text
                field_image_mask_shape: field_image_mask_shape_tablet
                field_hidden_viewports
                field_cdn_url
                field_options
                internal {
              ...
              ... on paragraph__markdown {
                ...
                field_zindex
                field_image_mask_shape: field_image_mask_shape_tablet
                field_text_shape_outside: field_text_shape_outside_tablet
                field_hidden_viewports
                field_options
                field_modal
                field_context_pane
